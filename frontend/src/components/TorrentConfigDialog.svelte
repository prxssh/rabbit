<script lang="ts">
  ...
  function formatDuration(ns: number): string {
    return (ns / 1_000_000_000).toString()
  }

  function parseDuration(seconds: string): number {
    return parseFloat(seconds) * 1_000_000_000
  }
        ...
        {#if activeTab === 'scheduler' && config.Scheduler}
          <div class="section">
            ...
            <div class="field">
              ...
              <select id="downloadStrategy" bind:value={config.Scheduler.DownloadStrategy}>
            ...
            <div class="field">
              ...
              <input
                ...
                max="100"
              />
              <span class="hint">Maximum concurrent requests per peer (default: 32)</span>
            </div>
            ...
            <div class="field">
              ...
              <input
                ...
                max="50"
              />
              <span class="hint">Minimum requests to keep pipeline full (default: 4)</span>
            </div>
            ...
            <div class="field">
              ...
              <input
                ...
                max="100"
              />
              <span class="hint">Remaining blocks to trigger endgame mode (default: 30)</span>
            </div>
          ...
          <div class="section">
            ...
            <div class="field">
              ...
              <input
                ...
                max="200"
              />
              <span class="hint">Maximum concurrent peer connections (default: 50)</span>
            </div>
            ...
            <div class="field">
              ...
              <input
                ...
                max="20"
              />
              <span class="hint">Number of peers to upload to simultaneously (default: 4)</span>
            </div>
          ...
          <div class="section">
            ...
            <div class="field">
              ...
              <input
                ...
                max="65535"
              />
              <span class="hint">Port for incoming peer connections (default: 6969)</span>
            </div>
            ...
            <div class="field">
              ...
              <input
                ...
                max="200"
              />
              <span class="hint">Number of peers to request from tracker (default: 50)</span>
            </div>
          </div>
        {/if}
      </div>
